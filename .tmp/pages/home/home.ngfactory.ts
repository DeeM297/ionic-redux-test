...
class _View_HomePage_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._HomePage_0_4 = new import3.HomePage(this.parentInjector.get(import8.NavController),this.parentInjector.get('AppStore'));
...
class _View_HomePage0 extends import1.AppView<import3.HomePage> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._appEl_24 = new import2.AppElement(24,9,this,this._el_24);
    var compView_24:any = import26.viewFactory_Button0(this.viewUtils,this.injector(24),this._appEl_24);
    this._Button_24_4 = new import15.Button((null as any),'',this.parentInjector.get(import16.Config),new import17.ElementRef(this._el_24),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.Button) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Button_24_4; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Button_24_4.ngAfterContentInit(); } }
  ...
  private _handle_click_24_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.context.testRedux()) !== false);
    return (true && pd_0);
  }
}
