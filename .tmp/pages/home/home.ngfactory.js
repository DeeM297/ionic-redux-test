...
var _View_HomePage0 = (function (_super) {
    ...
    _View_HomePage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_24 = import26.viewFactory_Button0(this.viewUtils, this.injector(24), this._appEl_24);
        this._Button_24_4 = new import15.Button(null, '', this.parentInjector.get(import16.Config), new import17.ElementRef(this._el_24), this.renderer);
    ...
    _View_HomePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import15.Button) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 25)))) {
    ...
    _View_HomePage0.prototype._handle_click_24_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.testRedux() !== false);
        return (true && pd_0);
    };
